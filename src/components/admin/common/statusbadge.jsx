...
const StatusBadge = ({ 
  ...
  const defaultConfigs = {
    ...
    suspended: { color: 'error', icon: <CloseCircleOutlined />, text: 'Suspended' },
    ...
    reviewing: { color: 'processing', icon: <SyncOutlined spin />, text: 'Reviewing' },
    rejected: { color: 'error', icon: <CloseCircleOutlined />, text: 'Rejected' },
    archived: { color: 'default', icon: <MinusCircleOutlined />, text: 'Archived' },
    
    // General statuses
    online: { color: 'success', icon: <CheckCircleOutlined />, text: 'Online' },
    offline: { color: 'default', icon: <MinusCircleOutlined />, text: 'Offline' },
    loading: { color: 'processing', icon: <SyncOutlined spin />, text: 'Loading' },
    ...
    medium: { color: 'warning', icon: <ExclamationCircleOutlined />, text: 'Medium' },
